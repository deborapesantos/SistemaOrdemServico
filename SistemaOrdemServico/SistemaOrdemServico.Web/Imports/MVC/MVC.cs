...
namespace MVC
{
    public static class Views
    {
        ...
        public static class Dashboard
        {
            public const string DirecionarServicos = "~/Views/Dashboard/DirecionarServicos.cshtml";
        }
        ...
        public static class SistemaOS
        {
            public static class Cliente
            {
                public const string ClienteIndex = "~/Modules/SistemaOS/Cliente/ClienteIndex.cshtml";
            }

            public static class Equipamento
            {
                public const string EquipamentoIndex = "~/Modules/SistemaOS/Equipamento/EquipamentoIndex.cshtml";
            }

            public static class Funcionario
            {
                public const string FuncionarioIndex = "~/Modules/SistemaOS/Funcionario/FuncionarioIndex.cshtml";
            }

            public static class OrdemServico
            {
                public const string OrdemServicoIndex = "~/Modules/SistemaOS/OrdemServico/OrdemServicoIndex.cshtml";
            }

            public static class SisPerfilFuncionario
            {
                public const string SisPerfilFuncionarioIndex = "~/Modules/SistemaOS/SisPerfilFuncionario/SisPerfilFuncionarioIndex.cshtml";
            }

            public static class SisTipoEquipamento
            {
                public const string SisTipoEquipamentoIndex = "~/Modules/SistemaOS/SisTipoEquipamento/SisTipoEquipamentoIndex.cshtml";
            }
        }
    }
}
