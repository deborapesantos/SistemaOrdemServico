...
namespace SistemaOrdemServico.SistemaOS.Entities
{
    ...
    {
        [DisplayName("Equipamento"), Identity]
        ...
        [DisplayName("Tipo Equipamento"), NotNull, ForeignKey("[dbo].[SisTipoEquipamento]", "CodigoTipoEquipamento"), LeftJoin("jCodigoTipoEquipamento")]
        [LookupEditor(typeof(SisTipoEquipamentoRow))]
        ...
        [DisplayName("Data da Última Visita")]
